...
namespace ButikAPI.Controllers
{
    ...
    [ApiController]
    public class BaseApiController<T,T2, T3> : ControllerBase
    {
        private readonly IBaseRepository<T> _baseRepository;
        private readonly IMapper _mapper;

        public BaseApiController(IBaseRepository<T> baseRepository, IMapper mapper)
        {
        ...
        {
            var vm = new ResponseViewModel<T2>();
